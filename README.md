...
3_empirical_evidence/: Contiene los grafos resultantes (CSV) exportados tras auditar el simulador privado. Utiliza la técnica de Graph Folding para presentar la "Topología Algorítmica" (Silos Semánticos y dependencias) en forma de Supernodos, ocultando el álgebra exacta por razones de confidencialidad.
...
Importe los archivos lineage_supernodes.csv y lineage_super_edges.csv desde la carpeta 3_empirical_evidence/ en un software de análisis de redes (ej. Gephi).
